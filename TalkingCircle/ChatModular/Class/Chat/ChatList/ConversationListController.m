...
#pragma mark  添加显示下拉菜单窗口
#define KPopView 1
- (void)addShowMenuAction:(UIButton*) btn
{
    NSLog(@"addShowListMenu");
...
- (void)defaultCell {
    ...
    NSArray *names =@[@"添加朋友",@"发起群聊",@"扫一扫",@"收付款",@"群发消息",@"帮助与反馈"];
    NSArray *images =@[@"add-friend",@"add-friend",@"add-qr-code",@"add-pay",@"group-news",@"add-help"];
