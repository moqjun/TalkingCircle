...
- (void)_setupBarButtonItem
{
    ...
    if (self.conversation.type == EMConversationTypeChat) {
        ...
        [clearButton setImage:[UIImage imageNamed:@"info-icon"] forState:UIControlStateNormal];
        ...
        [detailButton setImage:[UIImage imageNamed:@"group-chat"] forState:UIControlStateNormal];
        ...
        didSelectMessageModel:(id<IMessageModel>)messageModel
{
    if (messageModel.isSender) {
        return NO;
         ...
         messageModel.message.isRead = NO;
        messageModel.message.isReadAcked = NO;
        messageModel.message.isDeliverAcked = NO;
         [[EMClient sharedClient].chatManager sendMessageReadAck:messageModel.message completion:^(EMMessage *aMessage, EMError *aError) {
