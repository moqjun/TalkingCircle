...
//    SettingsViewController *_settingsVC;
    MQMineViewController *_mineVC;
//    __weak CallViewController *_callController;
    
    UIBarButtonItem *_addShowMenuItem;
...
//    [self didUnreadMessagesCountChanged];
    ...
    UIButton *addButton =[self createCustomButton];
    ...
    UIButton *menuBtn =[self createCustomButton];
    [menuBtn addTarget:_chatListVC action:@selector(addShowMenuAction:) forControlEvents:UIControlEventTouchUpInside];
    _addShowMenuItem = [[UIBarButtonItem alloc] initWithCustomView:menuBtn];
    
    self.navigationItem.rightBarButtonItem = _addShowMenuItem;
...
-(UIButton*) createCustomButton
{
    ...
    [addButton setImage:[UIImage imageNamed:@"home-add"] forState:UIControlStateNormal];
    return addButton;
}
...
- (void)tabBar:(UITabBar *)tabBar didSelectItem:(UITabBarItem *)item
{
    if (item.tag == 0) {
        ...
        self.title = @"联系人";//NSLocalizedString(@"title.addressbook", @"AddressBook");
        self.navigationItem.rightBarButtonItem = _addFriendItem;
    }else if (item.tag == 2){
        self.title = @"我的";//NSLocalizedString(@"title.setting", @"Setting");
...
//    self.tabBar.selectionIndicatorImage = [[UIImage imageNamed:@"tabbarSelectBg"] stretchableImageWithLeftCapWidth:25 topCapHeight:25];
    ...
    [self setTabBarItem:_chatListVC.tabBarItem itemTitle:@"洽谈圈" normalImage:@"nav-home" selectImage:@"nav-home-cur"];
    ...
    [self setTabBarItem:_contactsVC.tabBarItem itemTitle:NSLocalizedString(@"title.addressbook", @"AddressBook") normalImage:@"nav-lxr" selectImage:@"nav-lxr-cur"];
    
    [self unSelectedTapTabBarItems:_contactsVC.tabBarItem];
    [self selectedTapTabBarItems:_contactsVC.tabBarItem];
    
    _mineVC = [[MQMineViewController alloc] init];
    _mineVC.tabBarItem.tag = 2;
    [self setTabBarItem:_mineVC.tabBarItem itemTitle:NSLocalizedString(@"title.setting", @"Setting") normalImage:@"nav-my" selectImage:@"nav-my-cur"];
    _mineVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
    [self unSelectedTapTabBarItems:_mineVC.tabBarItem];
    [self selectedTapTabBarItems:_mineVC.tabBarItem];
    
    self.viewControllers = @[_chatListVC, _contactsVC, _mineVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}

-(void) setTabBarItem:(UITabBarItem *)tabBarItem itemTitle:(NSString*) title normalImage:(NSString *) normalIcon selectImage:(NSString *) selectIcon
{
    tabBarItem.title = title;
    tabBarItem.image =[[UIImage imageNamed:normalIcon] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    tabBarItem.selectedImage =[[UIImage imageNamed:selectIcon] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
...
-(void)selectedTapTabBarItems:(UITabBarItem *)tabBarItem
{
    [tabBarItem setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                        [UIFont systemFontOfSize:13],NSFontAttributeName,
                                        [UIColor colorWithHexString:@"0fb8d7"],NSForegroundColorAttributeName,
