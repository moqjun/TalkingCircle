...
- (void)enableSearchController
{
    ...
    [self.searchController.searchBar setImage:[UIImage imageNamed:@"search-icon"] forSearchBarIcon:UISearchBarIconSearch state:UIControlStateNormal];
    [self.searchController.searchBar setLeft:10];
    [self.searchController.searchBar changeLeftPlaceholder:@"搜索"];
   
    
    //设置背景图片
    [self.searchController.searchBar setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexString:@"d6d6d6"]] forBarPosition:UIBarPositionAny barMetrics:UIBarMetricsDefault];
