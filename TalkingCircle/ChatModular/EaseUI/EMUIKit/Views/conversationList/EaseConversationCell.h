...
/** @brief cell的最小高度 */
static CGFloat EaseConversationCellMinHeight = 70;
...
/** @brief 消息免打扰图标 */
@property (nonatomic) UIImageView *msgFreeImageView UI_APPEARANCE_SELECTOR;

/** @brief 是否显示消息免打扰图标，默认为YES */
@property (nonatomic) BOOL showMsgFreeImage;
